...
function LoadFunction()    
	...
	function LoadSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfolder("Hasaki Hub") then
				makefolder("Hasaki Hub")
			end
			if not isfolder("Hasaki Hub/Blox Fruits/") then
				makefolder("Hasaki Hub/Blox Fruits/")
			end
			if not isfile("Hasaki Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				writefile("Hasaki Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
			else
				local Decode = game:GetService("HttpService"):JSONDecode(readfile("Hasaki Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
	...
	function SaveSettings()
		if readfile and writefile and isfile and isfolder then
			if not isfile("Hasaki Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
				...
				writefile("Hasaki Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
			end
		else
			return warn("Status : Undetected Executor")
		end
...
function GetMaterial(matname)
	...
	CredtSection:AddLabel({
		Name = "Script Made By LeMinhNhat<3 | Made By Team XuanQuyet"
	})
			...
			if _G.AutoMirageIsland or _G.Mirage then
				if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
					...
					if _G.Mode == "English" then
						game:GetService("StarterGui"):SetCore("SendNotification",{Title = "HasakiHub",Text = "Mirage not Found!",Icon = "rbxassetid://14645512457",Duration = 1})
					else
						game:GetService("StarterGui"):SetCore("SendNotification",{Title = "HasakiHub",Text = "เกาะลับยังไม่เกิด",Icon = "rbxassetid://14645512457",Duration = 1})
					end
				end
			end
		end
...
FakeDamage("Hasaki Hub")
Vec("<Color=Yellow>Hasaki Hub loaded Finished<Color=/>")
	...
	game.Players.LocalPlayer:Kick("script Not Load!.Try Again")
end
