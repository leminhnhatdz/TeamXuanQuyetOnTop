...
do local GUI = game.CoreGui:FindFirstChild("RuaHub") if GUI then GUI:Destroy() end end
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://17405348145"
...
ImageButton1.Image = "rbxassetid://17405348145"
...
if game:GetService("CoreGui"):FindFirstChild("RuaHub") then
    game:GetService("CoreGui"):FindFirstChild("RuaHub"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    local RuaHub = Instance.new("ScreenGui")
    RuaHub.Name = "RuaHub"
    RuaHub.Parent = game.CoreGui
    RuaHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	...
	Logo.Image = "rbxassetid://17405348145"
...
Page.Image = ""
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://17405348145"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://17405348145"
